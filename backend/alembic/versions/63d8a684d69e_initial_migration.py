...
Revision ID: 63d8a684d69e
Revises: 
Create Date: 2025-04-03 20:22:14.970172
...
def upgrade() -> None:
    ...
    sa.Column('entry_timing', sa.Enum('before', 'after', 'outside', name='entrytimingtype'), nullable=False),
